...
export function Selector() {
    ...
    return (
      ...
      <div onClick={() => (setLoadingstate(true), setPages((0)), functionGet("https://leets1337-3f387c570577.herokuapp.com/api/v1/home"))} className="ml-4 w-[30px] h-[30px] flex items-center justify-center  border-solid border-white duration-200 bg-slate-900 rounded-[10px] border-[2px] cursor-pointer border-opacity-20 hover:scale-105">
