  ...
  const obj = [{year : 2013}, {year : 2014}, {year : 2015}, {year : 2016}, {year : 2017}, 
    ...
    return ( 
      ...
      <div className=" flex items-center justify-center flex-row rounded-[5px] h-[95%] w-[25%]">
        <div style={{boxShadow: '0px 0px 5px yellow'}}  className="cursor-pointer w-[50px] h-[50px] border-solid border-yellow-500  border-[2px] rounded-[50%]">
          <img src={localStorage.getItem('profileImage')} onClick={() => (functionVisible(visible, setVisible))} className="rounded h-[100%] w-[100%] object-cover" />
        </div>
          {visible &&
