...
export default function Scrol({objectvalue}) {
  ...
  console.log('Is all an array?', Array.isArray(all)); // Should log true if all is an array
    return(
        ...
        <div className="border-solid flex items-center justify-start flex-col duration-300 gap-[15px] lg:w-[70%]   md:w-[70%] h-[100%] max-w-[800px] rounded-[10px] xs:w-[100%] absolute z-50">
