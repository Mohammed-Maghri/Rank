    ...
    return(
...

        {
          student.map((item, index) => (
            <div style={{boxShadow: '0px 0px 5px white', backgroundColor : `${item.color}`}} className=" bg-gray-400 flex items-center justify-start w-[100%] max-w-[800px] h-[135px] rounded-[20px]">
              {/* <div className=" absolute w-[70px] h-[70px] border-solid z-100    top-[150px]">
                <img style={{transform: "rotate(-45deg)"}} src={taj}/>
              </div> */}
            <div  className="border-solid border-[1px] ml-[5px] flex items-center justify-center border-black xs:w-[120px] xs:min-w-[120px] rounded-l-[20px] md:w-[120px] md:min-w-[120px] h-[120]">
              <img  className="w-[100%] h-[114px] min-h-[105px] rounded-l-[20px]" src={item.pic}/>
            </div>
            <div style={{boxShadow: '0px 0px 5px black'}} className=" flex items-center flex-col justify-center h-[91%] max-h-[130px] rounded-r-[20px] xs:w-[260px] xm:w-[520px] sm:w-[660px] md:w-[600px] lg:w-[670px] mr-[5px] bg-white">
