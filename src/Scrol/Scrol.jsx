    ...
    return(
        ...
        }
        {
          all.slice(0).map((item, index) => (
            <div onClick={() => (cardSlect(index))}  key={index} style={{ backgroundColor : `transparent`}} className="z-50 bg-gray-400 flex items-center justify-start w-[100%] max-w-[800px] rounded-[20px] duration-500 cursor-pointer  h-[140px]">
